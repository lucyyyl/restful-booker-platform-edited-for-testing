    ...
    return <div>
                <div className="row room-form">
                    ...
                    <div className="col-sm-2">
                        <select className="form-control" id="type" data-testid="room-type-dropdown" value={newRoom.type} onChange={e => updateState(e.target)}>
                    ...
                    <div className="col-sm-2">
                        <select className="form-control" id="accessible" data-testid="room-accessible-dropdown" value={newRoom.accessible} onChange={e => updateState(e.target)}>
                            <option value="false">false</option>
                            <option value="true">true</option>
                        </select>
                    </div>
                    <div className="col-sm-1">
                        <input className="form-control" type="text" id="roomPrice" data-testid="room-price" value={newRoom.roomPrice} onChange={e => updateState(e.target)} />
                    </div>
                    ...
                    <div className="col-sm-1">
                        <button className="btn btn-outline-primary" id="createRoom" data-testid="create-room-button" type="submit" onClick={createRoom}>Create</button>
                    </div>
                </div>
                {errorMessages}
            </div>
