...
const HotelRoomInfo = ({roomDetails}) => {
    ...
    if(book){
        ...
        button = <button type='button' className='btn btn-outline-primary float-right openBooking' data-testid="book-room-button" onClick={toggleBooking}>Book this room</button>
    }

    return(
        <div>
            <div className="row hotel-room-info" data-testid="hotel-room-row">
