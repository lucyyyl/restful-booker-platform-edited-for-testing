	...
	return(
			<nav className="navbar navbar-expand-md navbar-dark bg-dark">
				...
				<div className="mx-auto order-0">
						<a className="navbar-brand mx-auto" data-testid="booking-management-title" href="#">B&B Booking Management</a>
				...
				<div className="navbar-collapse collapse w-100 order-3 dual-collapse2">
					{isAuthenticated && (
						<ul className="navbar-nav ml-auto">
								...
								<li className="nav-item">
										<a className="nav-link" data-testid="logout-button" href="#/admin" onClick={doLogout}>Logout</a>
								</li>
						</ul>
					)}
				</div>
