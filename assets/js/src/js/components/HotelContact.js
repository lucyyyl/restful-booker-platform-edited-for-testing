...
const HotelContact = ({contactDetails}) => {
    ...
    if(errorMessages.length > 0){
        errors = <div className="alert alert-danger" data-testid="contactForm-errorAlert" style={{marginBottom : 5 + "rem"}}>
    ...
    if(submitted){
        form = <div data-testid="ContactSuccess" style={{height : "412px"}}>
        ...
        form = <form>
                ...
                <br />
                {errors}
                <button type='button' className='btn btn-outline-primary float-right' data-testid="ContactSubmitButton" id="submitContact" onClick={submitForm}>Submit</button>
            </form>
    }
